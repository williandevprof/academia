              ...
              <div class="tab-content pn br-n admin-form">
                <div id="tab1_1" class="tab-pane active">
                  ...
                  <div class="section row mbn">
                    ...
                    <div ng-hide="mostraListaUsuarios">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-5">
                          <label for="firstname" class="field prepend-icon">
                            <input ng-model="pessoa.buscarPessoa"  type="text" class="gui-input" placeholder="Digite o nome da pessoa para a busca"
                            ng-keyup="autoPessoa(pessoa.buscarPessoa)" uib-typeahead="autoPessoa as autoPessoa.nome for autoPessoa in autoPessoas | filter:$viewValue | limitTo:8">
                        ...
                        <div class="col-md-2">
                          <button ng-click="pesquisarPessoa()" class="button btn-primary">Buscar&nbsp;<i class="fa fa-search"></i></button>
                        </div>
                      </div>
                      <br><br>
                      ...
                      <div>
                        <table  class="table table-bordered table-striped table-hover">
                          ...
                          <tr dir-paginate="usuario in usuarios|itemsPerPage:7">
                            <td>
                              <center>
                                <div >
                                  <!-- Lista a foto se o idpessoa de pessoa for igual o idpessoa-->
                                  <img ng-repeat="image in images"  ng-if="usuario.idpessoa == image.idpessoa" style="width: 125px; height: 75px;" ng-src="../Academia/api_fotos/images/{{image.foto}}" ng-click="openImg($event, usuario, image)">
                                </div> 
                              </center>  
                            </td>
                            ...
                            <td ng-if="usuario.ativo == 1">Ativo</td>
                            <td ng-if="usuario.ativo == 0">Inativo</td>
                                                                                   
                            <td>
                                <button class="btn btn-warning" ng-click="editarPermissao(usuario, image)">Editar Permissao&nbsp;  <span class="icon-write"></span>
                                </button>
                            </td>
                            <td></td>
