<div ng-controller="avaliacao_fisica">
            ...
            <div class="panel-body p20 pb10">
              <div class="tab-content pn br-n admin-form">
                <div id="tab1_1" class="tab-pane active">
                  ...
                  <?php include_once("form_avaliacao.php"); ?>
                  <?php include_once("lista_avaliacao.php"); ?>	
                  ...
                  <div ng-hide="mostraListaAluno">	
	                  <div class="section row mbn">
	                      ...
	                      <div  class="section-divider mb40">
	                        <span>Lista de Alunos Para Avaliações Físicas</span>
	                      </div>
	                        ...
	                        <table  class="table table-bordered table-striped table-hover">
	                          <tr>
	                            ...
	                            <?php
						            ...
						            // seleciona a permissao de cadastrar avaliação fisica para esse usuário
						            ...
						            if ($retornoAvaliacao['cadastrar'] == 1) 
						            {
	                          ...
	                          <tr dir-paginate="aluno in alunos|itemsPerPage:7">
	                            ...
	                            <?php
						            ...
						            if ($retornoAvaliacao['cadastrar'] == 1) 
						            {
						              ...
						              ?>   
			                            <td>
			                                <button class="btn btn-success" ng-click="addAvaliacao(aluno, aluno.idaluno, image)">Nova Avaliação&nbsp;  <i class="fa fa-plus"></i>
			                                </button>
			                            </td>
			                          <?php
			                          	}
	                            ...
	                            <td>
	                                <button class="btn btn-info" ng-click="listaAvaliacao(aluno, image)">Listar Avaliações&nbsp;  <i class="fa fa-search"></i>
	                                </button>
	                            </td>
                  ...
                  <script type="text/ng-template" id="dialogValidaAvaliacaoFisica">
                    <div class="ngdialog-message">
                        <h3>{{validaAvaliacaoFisica}}</h3>
                        <p ng-show="theme">Test content for <code>{{theme}}</code></p>
                    </div>
                    <div class="ngdialog-buttons">
                        <button type="button" class="ngdialog-button ngdialog-button-primary" ng-click="okValidaAvaliacao()">OK</button>
                    </div>
                  </script> 
