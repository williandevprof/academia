<header class="navbar navbar-fixed-top" ng-controller="header">
  <!-- inicio do formulario -->
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown">
        ...
        <!-- mostra o nome e a foto do usuario logado -->
        <div ng-repeat="usuario in usuario" 
        class="dropdown-toggle fw600 p15" data-toggle="dropdown">

            <div ng-repeat="image in images" ng-if="usuario.idpessoa == image.idpessoa"> 
              
              <img  ng-src="../Academia/api_fotos/images/{{image.foto}}"
               alt="avatar" class="mw30 br64 mr15"> {{usuario.nome}}
        ...
        <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
          <li class="list-group-item">
            <a href="#/meus_treinos" class="animated animated-short fadeInUp">
              <span class="fa fa-envelope"></span> Meus Treinos
            </a>
          </li>
          <li class="list-group-item">
          ...
          <li class="list-group-item">
            <a href="#" ng-click="logout()" class="animated animated-short fadeInUp">
              <span class="fa fa-power-off"></span> Sair </a>
          </li>
        </ul>
      </li>
    </ul>
